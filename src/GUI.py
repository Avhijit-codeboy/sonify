...
class MainWindow(QMainWindow):
    ...
    def CreateDrawer(self):
        ...
        # Play Button
        self.playButton = QPushButton(QIcon(ICON_DIR + "icon_play.png"), "")
    ...
    def InitMenubar(self):
        ...
        self.action_file_open = QAction(QIcon(ICON_DIR + "icon_open.png"), "Open", self)
        self.action_file_open.setShortcut("Ctrl+O")

        self.action_file_exit = QAction(QIcon(ICON_DIR + "icon_exit.png"), "Exit", self)
        ...
        self.action_edit_prefs = QAction(QIcon(ICON_DIR + "icon_prefs.png"), "Preferences", self)
